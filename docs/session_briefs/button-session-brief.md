...
.button--danger { /* danger variant styles */ }

/* NOT this utility class approach */
.bg-blue-500.text-white.px-4.py-2.rounded { /* avoid! */ }
```
...
.button--pressed { /* pressed/active styles */ }
```
...
<ui-button class="bg-blue-500 text-white px-6 py-3 rounded-lg font-semibold">
  ...
</ui-button>
```
